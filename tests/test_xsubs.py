...
def test_get_matches_episode(episodes):
    subtitle = XSubsSubtitle(Language.fromalpha2('el'), '', 'The Big Bang Theory', 7, 5, 'The Workplace Proximity',
                             '720p.HDTV DIMENSION', '')
    matches = subtitle.get_matches(episodes['bbt_s07e05'])
    assert matches == {'series', 'season', 'episode', 'release_group', 'title', 'resolution', 'source'}
