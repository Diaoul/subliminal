...
class OpenSubtitlesSubtitle(Subtitle):
    ...
    def get_matches(self, video: Video) -> set[str]:
        ...
        # guess
        matches |= guess_matches(video, safe_guessit(self.movie_release_name, {'type': self.movie_kind}))
        matches |= guess_matches(video, safe_guessit(self.filename, {'type': self.movie_kind}))
