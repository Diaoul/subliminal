    ...
    return {
        'man_of_steel': Movie(
            ...
            hashes={
                ...
                'opensubtitlescom': '5b8f8f4e41ccb21e',
                'shooter': (
        ...
        'jack_reacher_never_go_back': Movie(
            ...
            external_ids={'imdb_id': 'tt3393786'},
            year=2016,
        ),
    }
    ...
    return {
        'bbt_s07e05': Episode(
            ...
            hashes={
                ...
                'opensubtitlescom': '6878b3ef7c1bd19e',
                'shooter': (
        ...
        'got_s03e10': Episode(
            ...
            hashes={
                ...
                'opensubtitlescom': 'b850baa096976c22',
                'shooter': (
...
def cli_runner(capsys: pytest.CaptureFixture[str], tmp_path: os.PathLike[str]) -> dict[str, str]:
    ...
    def with_capture(method: Callable[..., CliResult]) -> Callable[..., CliResult]:
        ...
        def run_with_capture(self: CliRunner, *args: Any, **kwargs: Any) -> CliResult:
            ...
            ret.out, ret.err = capsys.readouterr()
