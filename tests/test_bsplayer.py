...
from subliminal.providers.bsplayer import (
    BSPlayerProvider, BSPlayerSubtitle
)
...
def test_get_matches_movie_hash(episodes):
    subtitle = BSPlayerSubtitle(subtitle_id='16442520', size=12185, page_link=None, language=Language('spa'),
                                filename='The.Big.Bang.Theory.S07E05.720p.HDTV.X264-DIMENSION.srt',
                                subtitle_format='srt', subtitle_hash='dbaf71fc665f83a716ae3f5daa62b7a0', rating='5',
                                season=None, episode=None, encoding=None, imdb_id='2557490', imdb_rating=None,
                                movie_year=None, movie_name=None, movie_hash='6878b3ef7c1bd19e', movie_size='0',
                                movie_fps='0')
...
def test_query_hash_size(movies):
    ...
    expected_subtitles = {'16406078', '16416262', '16418130', '16443177', '16459402', '16460111', '16461946',
                          '16471760', '16476519', '16478096', '16478430', '16479531', '16480125', '16511626',
                          '16615164', '16690745', '16833591', '16920391', '16935990', '17406400', '17580179'}
