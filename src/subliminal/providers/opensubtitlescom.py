...
class OpenSubtitlesComSubtitle(Subtitle):
    ...
    def get_matches(self, video: Video) -> set[str]:
        ...
        # guess
        matches |= guess_matches(video, safe_guessit(self.release, {'type': self.movie_kind}))
        matches |= guess_matches(video, safe_guessit(self.file_name, {'type': self.movie_kind}))
