...
@pytest.mark.integration
@vcr.use_cassette
def test_query_movie_no_match(movies):
    language = Language('zho')
...
@pytest.mark.integration
@vcr.use_cassette
def test_query_episode_by_hash(episodes):
...
@pytest.mark.integration
@vcr.use_cassette
def test_query_episode_no_match(episodes):
...
@pytest.mark.integration
@vcr.use_cassette
def test_query_episode_by_name(episodes):
