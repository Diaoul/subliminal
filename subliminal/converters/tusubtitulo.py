...
class TuSubtituloConverter(LanguageReverseConverter):
    def __init__(self):
        ...
        self.from_tusubtitulo = {u'Español': ('spa',), u'Español (España)': ('spa',), u'Español (Latinoamérica)': ('spa','MX'),
    ...
    def convert(self, alpha3, country=None, script=None):
        if (alpha3, country, script) in self.to_tusubtitulo:
            return self.to_tusubtitulo[[alpha3, country, script]]
