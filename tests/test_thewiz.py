...
from subliminal.providers.thewiz import TheWizProvider, TheWizSubtitle


vcr = VCR(path_transformer=lambda path: path + '.yaml',
          record_mode=os.environ.get('VCR_RECORD_MODE', 'once'),
          match_on=['method', 'scheme', 'host', 'port', 'path', 'query', 'body'],
          cassette_library_dir=os.path.realpath(os.path.join('tests', 'cassettes', 'thewiz')))


def test_get_matches_movie(movies):
    releases = ['Enders.Game.2013.720p.BluRay.x264-SPARKS']
    subtitle = TheWizSubtitle(Language('heb'), False, None, None, None, None, 'Ender\'s Game', 'tt1731141',
                              '18947', releases)
...
def test_get_matches_episode(episodes):
    ...
    subtitle = TheWizSubtitle(Language('heb'), False, None, 'Game of Thrones', 3, 10, 'Mhysa', 'tt0944947',
                              '3748', releases)
...
def test_search_imdb_id_episode(episodes):
    ...
    with TheWizProvider() as provider:
...
def test_search_imdb_id_no_suggestion():
    with TheWizProvider() as provider:
        imdb_id = provider._search_imdb_id('DCs Legend of Tomorrow', 0, False)
...
def test_list_subtitles_movie(movies):
    ...
    expected_subtitles = {'24351', '24353', '24355', '24357', '24359', '24361', '24363', '24366', '24368', '24370',
                          '24372', '24374', '24376', '24378', '24380', '95805', '24382', '24384', '24386', '24388',
                          '24390', '24392', '24394', '24396', '62796', '62797', '24398', '24400', '24402', '24404',
                          '24405', '24408', '24410', '90978', '64634', '114837', '77724', '134085', '134088', '75722',
                          '134091', '155340', '66283'}
    with TheWizProvider() as provider:
