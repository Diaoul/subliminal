...
@click.option('--subz', type=click.STRING, nargs=2, metavar='USERNAME PASSWORD', help='Subz configuration.')
...
@click.pass_context
def subliminal(ctx, addic7ed, legendastv, opensubtitles, subz, cache_dir, debug):
    ...
    if subz:
        ctx.obj['provider_configs']['subz'] = {'username': subz[0], 'password': subz[1]}
